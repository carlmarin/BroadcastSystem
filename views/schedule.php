        ...
        $(document).ready(function () {
            ...
            $('#Report').jtable({
                ...
                actions: {
                   ...
                   createAction: '../php/tablePhp/scheduleServerSide.php?action=create',
                   updateAction: '../php/tablePhp/scheduleServerSide.php?action=update',
                   deleteAction: '../php/tablePhp/scheduleServerSide.php?action=delete'
                },
                fields: {
                    sched_id: {
                        key: true,
