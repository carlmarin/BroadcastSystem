...
<script type="text/javascript" src="../jtable/dev/jquery.jtable.sorting.js"></script>
  ...
  <body>
    ...
    <div class="row">
        <div class="col-sm-12" id="machinery" style="width:100%; padding:3%;"></div>
    </div>
            ...
            $('#machinery').jtable({
              ...
              //  columnResizable: false,
                ...
                actions: {
                   ...
                   createAction: '../php/tablePhp/machineServerSide.php?action=create',
                   updateAction: '../php/tablePhp/machineServerSide.php?action=update',
                    deleteAction: '../php/tablePhp/machineServerSide.php?action=delete'
                },
                fields: {
                    machine_id: {
                        key: true,
